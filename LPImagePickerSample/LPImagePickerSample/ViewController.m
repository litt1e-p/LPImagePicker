...
//    NSArray *fileList = [mgr contentsOfDirectoryAtPath:[[NSBundle mainBundle] resourcePath] error: nil];
//    NSString *regex = @"[0-9]*";
//    NSPredicate *pred = [NSPredicate predicateWithFormat:@"SELF MATCHES %@",regex];
//    NSMutableArray *tempArr = [NSMutableArray array];
//    
//    for (int i = 0; i < [fileList count] - 1; i++) {
//        if ([pred evaluateWithObject:fileList[i]]) {
//            NSString *p = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:fileList[i]];
//            [tempArr addObject:[NSURL fileURLWithPath:p]];
//        }
//    }
//    self.imgArr = tempArr;
